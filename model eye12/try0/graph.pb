  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\000\030\000\000\200\000\000\000"
      }
    }
  }
}
  ...
  attr {
    ...
    value {
      tensor {
        ...
        float_val: 0.012757759541273117
      }
    }
  }
}
...
node {
  name: "gradients/Square_4_grad/mul/x"
  op: "Const"
...
node {
  ...
  op: "Mul"
  input: "gradients/Square_4_grad/mul/x"
  input: "sub_7"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/sub_7_grad/Shape"
  op: "Shape"
  input: "output"
  attr {
    key: "T"
...
node {
  name: "gradients/sub_7_grad/Shape_1"
  op: "Shape"
  input: "input_label"
  attr {
    key: "T"
...
node {
  name: "gradients/sub_7_grad/BroadcastGradientArgs"
  op: "BroadcastGradientArgs"
  input: "gradients/sub_7_grad/Shape"
  input: "gradients/sub_7_grad/Shape_1"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  ...
  input: "gradients/sub_7_grad/BroadcastGradientArgs"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/sub_7_grad/Sum_1"
  op: "Sum"
  input: "gradients/Square_4_grad/mul_1"
  input: "gradients/sub_7_grad/BroadcastGradientArgs:1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  ...
  op: "Neg"
  input: "gradients/sub_7_grad/Sum_1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/sub_7_grad/Reshape_1"
  op: "Reshape"
...
node {
  ...
  input: "^gradients/sub_7_grad/Reshape_1"
}
node {
...
node {
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/sub_7_grad/Reshape_1"
      }
    }
  }
}
