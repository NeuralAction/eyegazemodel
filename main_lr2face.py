...
if __name__ == "__main__":
    ...
    savedir = "C:\\Users\\AinL\\Documents\\Visual Studio Code\\eyegazemodels\\model eye15\\"
    modeltitle = "face_isef"
    #opt options
    useSELU = True
    useBnorm = False
    ...
    p = multiprocessing.Pool(processes=int(round(multiprocessing.cpu_count() * 0.99)-1))
    ...
    datatest.debug = data.debug

    #nn operations
    
    Train(saveCheckPoint, loadmodel=loadCheckPoint, ep=250, useBnorm=useBnorm, bsize=125, tbsize=125, debugStep=15, decayEphoc=15)
    FreezeGraph()
