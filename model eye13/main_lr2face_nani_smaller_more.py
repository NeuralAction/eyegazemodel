...
def eval(bsize=20, tbsize=20, ep = 25, lr = 1e-4, debugstep=8, savepath=None, savemodel = False, useBnorm = True, droprate = 0.5, decay_ephoc=1, decay_rate=0.8, loadmodel=False):
    ...
    #face
    f_pool = conv2dSingle(x_f, phase_train, useBnorm, [7, 7, 16]) #30
    ...
    print("Total Weight Count:", totalWeightCount())
...
if __name__ == "__main__":
    ...
    savedir = "C:\\Users\\AinL\\Documents\\Visual Studio Code\\eyegazemodels\\model eye13\\smallermore\\"
    modeltitle = "face2"
    #use selu options
    useSELU = True
    #batch norm
    ...
    #operations
    Train(saveCheckPoint, loadmodel=loadCheckPoint, ep=250, useBnorm=useBnorm, bsize=40, tbsize=30, debugStep=10, decayEphoc=15)
    FreezeGraph()
