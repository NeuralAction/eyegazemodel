    ...
    with tf.Session() as sess:
        ...
        for i in range(0, int(data.size * ephoc / batch_size)):
            ...
            if i !=0 and i % debugstep == 0:
                ...
                acc_count+=1
                #run test acc
                tbatch_img_l, tbatch_img_r, tbatch_label = datatest.batch(batch_size, randomize = True)
...
if __name__ == "__main__":
    ...
    newdata = [basedir + "eyesub1\\", basedir + "eyesub2\\", basedir + "eyesub3\\", basedir + "eyesub4\\", basedir + "eyesub5\\", basedir + "eyesub6\\", basedir + "eyesub7\\"]

    data = eyemodel_LR.decodeData(["C:\\Library\\정올 2017\\Source\\NeuralAction\\Vision\\MPIGazeAnnotaionReader\\bin\\Debug\\save\\",
                                    "C:\\Library\\정올 2017\\Source\\NeuralAction\\Vision\\EyeGazeGen\\bin\\x64\\Debug\\Vision\\[2017-06-04 오후 10-28-31] sub coreM without Glasses - with sub\\[2017-08-13 오후 5-53-04] EyesSubModule\\"], p)
    data.imagesize = 60

    datatesttarget = ["C:\\Library\\정올 2017\\Source\\NeuralAction\\Vision\\EyeGazeGen\\bin\\x64\\Debug\\Vision\\[2017-08-03 오전 1-17-11] valid\\[2017-08-13 오후 6-12-56] EyesSubModule\\",
                      "C:\\Library\\정올 2017\\Source\\NeuralAction\\Vision\\EyeGazeGen\\bin\\x64\\Debug\\Vision\\[2017-08-02 오후 4-42-11] main - 복사본\\[2017-08-13 오후 6-04-42] EyesSubModule\\"]
    datatest = eyemodel_LR.decodeData(newdata, p)
    datatest.imagesize = 60
    
    logdir = "C:\\Users\\AinL\\Documents\\Visual Studio Code\\eyegazemodels\\log\\"
    savedir = "C:\\Users\\AinL\\Documents\\Visual Studio Code\\eyegazemodels\\model eye9\\"
    modeltitle = "hi"
    
    #HyperparamatersOpt()
    #Train(False)
    #FreezeGraph()
    ModelTest("frozen_gazeEx.pb", 200)