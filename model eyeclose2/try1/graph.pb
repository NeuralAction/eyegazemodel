  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\003\000\000\000\003\000\000\000\003\000\000\000\024\000\000\000"
      }
    }
  }
}
  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "@\001\000\0000\000\000\000"
      }
    }
  }
}
  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "0\000\000\000\002\000\000\000"
      }
    }
  }
}
...
node {
  name: "Variable_16/initial_value"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  ...
  op: "Assign"
  input: "Variable_16"
  input: "Variable_16/initial_value"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "clip_by_value_26/Minimum/y"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "clip_by_value_26/Minimum"
  op: "Minimum"
  input: "gradients/MatMul_1_grad/tuple/control_dependency_1"
  input: "clip_by_value_26/Minimum/y"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "clip_by_value_26"
  op: "Maximum"
  input: "clip_by_value_26/Minimum"
  input: "clip_by_value_26/y"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "clip_by_value_27/Minimum/y"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "clip_by_value_27/Minimum"
  op: "Minimum"
  input: "gradients/Add_1_grad/tuple/control_dependency_1"
  input: "clip_by_value_27/Minimum/y"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "clip_by_value_27"
  op: "Maximum"
  input: "clip_by_value_27/Minimum"
  input: "clip_by_value_27/y"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
