...
def eval(bsize=20, tbsize=20, ep = 25, lr = 1e-4, debugstep=8, savepath=None, savemodel = False, useBnorm = True, droprate = 0.5, decay_ephoc=1, decay_rate=0.8, loadmodel=False):
    ...
    h_pool = mobileLayer(h_pool, phase_train, useBnorm, [3, 3, 64], poolsize = 1)
...
if __name__ == "__main__":
    ...
    Train(True, loadmodel=False, ep=60, useBnorm=useBnorm, bsize=50, tbsize=50, debugStep=20, decayEphoc=4)
    FreezeGraph()
