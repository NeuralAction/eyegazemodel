...
def eval(bsize=20, tbsize=20, ep = 25, lr = 1e-4, debugstep=8, savepath=None, savemodel = False, useBnorm = True, droprate = 0.5, decay_ephoc=1, decay_rate=0.8, loadmodel=False):
    ...
    f_pool = mobileLayer(f_pool, phase_train, useBnorm, [3, 3, 64], poolsize = 1)
    ...
    fi_pool = fc(fi_pool, 128, keep_prob, phase_train)
    print(fi_pool)
    ...
    if(useBnorm):
        ...
        train_step = tf.train.GradientDescentOptimizer(learning_rate * 10)
